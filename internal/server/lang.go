...
// Localization of server-side strings. Language: the X-Polka-Lang header
...
var serverStrings = map[string]map[string]string{
	"ru": {
		...
		"shelf.collection.sub": "В библиотеке %d из %d",
	...
	"en": {
		...
		"shelf.collection.sub": "%d of %d in the library",
